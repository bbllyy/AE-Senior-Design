...
CD_0 = 0.0101;                   %Estimate for min drag coefficient
CD_R = 0;
CL_min = 0.35;                     %CL at alpha = 0
CL_max_set = 1.398;                 %Set CL_max
%CL_Vmax = 0.1;
...
%Vstall = 53;
WTO_S_stall = CL_max_set*.5*rho_SL*1.2*Vstall^2;
...
beta = 1;
alpha = 1;
Vset = 45*1.69;                %Max Cruise Speed (conversion of knots to fps)
